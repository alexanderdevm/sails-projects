...
angular.module('brushfire_videosPage').controller('PageCtrl', [
    ...
    function ($scope, $http) {
        ...
        $scope.submitNewVideo = function () {
            ...
            var youtubeID = parser.search.substring(parser.search.indexOf(
                '=') + 1, parser.search.length);

            _newVideo.src = 'https://www.youtube.com/embed/' +
                youtubeID;
