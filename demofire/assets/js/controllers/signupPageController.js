/*global window */
angular.module('brushfire').controller('signupPageController', ['$scope', '$http', 'toastr',
            ...
            $http.post('/user/signup', {
                ...
                .catch(function onError(sailsResponse) {
                    ...
                    if (sailsResponse.status === 409) {
                        ...
                        // $scope.signupForm.errorMsg =
                        //     'An unexpected error occurred: ' + (sailsResponse.data ||
                    ...
                    $scope.signupForm.errorMsg = 'An unexpected error occurred: ' +
